...
- (BOOL)_performCreateOperation:(id)arg1 withContext:(CDAnonymousStruct2 *)arg2;
- (BOOL)_performDeleteOperation:(id)arg1 withContext:(CDAnonymousStruct2 *)arg2;
- (BOOL)_performStoreOperation:(id)arg1 ignoringUids:(id)arg2 withContext:(CDAnonymousStruct2 *)arg3;
- (BOOL)_performAppendOperation:(id)arg1 withContext:(CDAnonymousStruct2 *)arg2 backupManager:(id)arg3 suggestedOfflineRestoreName:(id)arg4 recoveredMailboxName:(id *)arg5 error:(id *)arg6;
- (BOOL)_performCopyOperation:(id)arg1 withContext:(CDAnonymousStruct2 *)arg2 failedSourceUids:(id)arg3 error:(id *)arg4;

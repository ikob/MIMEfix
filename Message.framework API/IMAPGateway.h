...
@property(retain) NSLock *clientCountLock; // @synthesize clientCountLock=_clientCountLock;
// Preceeding property had unknown attributes: P
// Original attribute string: T@"NSLock",&,V_clientCountLock,P
...
// Preceeding property had unknown attributes: P
// Original attribute string: T@"IMAPClientOperationQueue",&,V_operationQueue,P

@property(retain) IMAPConnection *connection; // @synthesize connection=_connection;
// Preceeding property had unknown attributes: P
// Original attribute string: T@"IMAPConnection",&,V_connection,P
...
- (id)searchUidRange:(CDAnonymousStruct11)arg1 forTerms:(id)arg2;
- (id)searchUidRange:(CDAnonymousStruct11)arg1 forNewMessageIDs:(id)arg2;

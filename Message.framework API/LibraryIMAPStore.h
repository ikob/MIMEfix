...
- (void)_updateFlagsAfterSettingEncoding:(unsigned int)arg1 forMessages:(id)arg2;
- (BOOL)synchronouslySetPreferredEncoding:(unsigned int)arg1 forMessages:(id)arg2;
- (BOOL)setPreferredEncoding:(unsigned int)arg1 forMessages:(id)arg2;
...
- (void)_updateCacheInfoForPath:(id)arg1 rootPathToTrim:(id)arg2 scanSubDirectories:(BOOL)arg3;

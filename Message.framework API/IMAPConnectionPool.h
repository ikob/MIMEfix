...
// Original attribute string: T@"NSMutableArray",&,V_suspendedGateways,P
...
// Preceeding property had unknown attributes: P
// Original attribute string: T@"NSMutableDictionary",&,V_activeConnectionsByMailbox,P
...
// Preceeding property had unknown attributes: P
// Original attribute string: T@"NSMutableDictionary",&,V_idleConnectionsByMailbox,P

@property(retain) NSCondition *availabilityCondition; // @synthesize availabilityCondition=_availabilityCondition;
// Preceeding property had unknown attributes: P
// Original attribute string: T@"NSCondition",&,V_availabilityCondition,P

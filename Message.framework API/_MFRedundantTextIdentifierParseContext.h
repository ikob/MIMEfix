...
- (id)initWithBuffer:(CDStruct_7e4886f7 *)arg1 bufferStartIndex:(unsigned long long)arg2 bufferLength:(unsigned long long)arg3 searchInForwardDirection:(BOOL)arg4 attachmentContextsByURL:(id)arg5;
- (void)dealloc;
- (id)description;

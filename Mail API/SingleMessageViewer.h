...
@property(retain) NSOperation *proxyIconOperation; // @synthesize proxyIconOperation=_proxyIconOperation;
// Preceeding property had unknown attributes: N
// Original attribute string: T@"NSOperation",&,N,V_proxyIconOperation

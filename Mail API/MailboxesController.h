...
@class MailboxUid, MailboxesChooser, NSArray, NSButton, NSConditionLock, NSMutableDictionary, NSMutableSet, NSPopUpButton, NSTextField, NSView, NSWindow;
...
- (id)_smartMailboxesDictionaryRepresentationsFilteredForSync:(BOOL)arg1;

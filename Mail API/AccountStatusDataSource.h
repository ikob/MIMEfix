...
@interface AccountStatusDataSource <NSMenuDelegate, NSTableViewDataSource, NSTableViewDelegate>
{
...
@property(retain) Account *dynamicAccount;
// Preceeding property had unknown attributes: D
// Original attribute string: T@"Account",&,D
...
// Preceeding property had unknown attributes: D
// Original attribute string: T@"NSArray",C,D

@property(retain) AccountStatus *statusProvider;
// Preceeding property had unknown attributes: D
// Original attribute string: T@"AccountStatus",&,D

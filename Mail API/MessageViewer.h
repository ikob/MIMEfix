...
@interface MessageViewer <MailboxesOutlineViewControllerDelegate, MessageTransferDelegate, MVMailboxSelectionOwner, NSAnimationDelegate, NSSpeechSynthesizerDelegate, NSSplitViewDelegate, NSUserInterfaceValidations, NSWindowDelegate, MVTerminationHandler>
{
...
@property(copy) NSString *searchPhrase;

...
@interface MessageMall <MessageConsumer>
{
...
@property(retain) NSArray *mailboxUidsToSetAfterDelay; // @synthesize mailboxUidsToSetAfterDelay=_mailboxUidsToSetAfterDelay;
// Preceeding property had unknown attributes: N
// Original attribute string: T@"NSArray",&,N,V_mailboxUidsToSetAfterDelay

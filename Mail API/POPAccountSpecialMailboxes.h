...
@property BOOL moveDeletedMessagesToTrash; // @synthesize moveDeletedMessagesToTrash=_moveDeletedMessagesToTrash;
// Preceeding property had unknown attributes: N
// Original attribute string: Tc,N,V_moveDeletedMessagesToTrash
